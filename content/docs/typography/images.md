...
<img class="h-auto max-w-full" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
...
<figure class="max-w-lg">
  <img class="h-auto max-w-full rounded-lg" src="/images/examples/image-3@2x.jpg" alt="image description">
...
<img class="h-auto max-w-lg rounded-lg" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
...
{{< example id="image-rounded-example" class="flex justify-center" github="typography/images.md" show_dark=true >}}
<img class="rounded-full w-96 h-96" src="/images/examples/image-4@2x.jpg" alt="image description">
{{< /example >}}
...
<img class="h-auto max-w-xl rounded-lg shadow-xl dark:shadow-gray-800" src="/images/examples/image-2@2x.jpg" alt="image description">
{{< /example >}}
...
<img srcset="/images/examples/image-1.jpg 1x, /images/examples/image-1@2x.jpg 2x" class="w-full h-auto max-w-xl rounded-lg" alt="image description">
{{< /example >}}
...
<img class="h-auto max-w-lg" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
...
<img class="h-auto max-w-lg mx-auto" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
...
<img class="h-auto max-w-lg ms-auto" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
...
<img class="h-auto max-w-xs" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
...
<img class="h-auto max-w-md" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
...
<img class="h-auto max-w-xl" src="/images/examples/image-1@2x.jpg" alt="image description">
{{< /example >}}
