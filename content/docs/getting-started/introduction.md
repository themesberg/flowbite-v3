...
<div class="mt-10 lg:grid lg:grid-cols-2 lg:gap-8">
    <a href="{{< ref "docs/getting-started/quickstart" >}}" class="block p-6 mb-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-100 dark:border-gray-700 lg:mb-0">
    ...
    <a href="{{< ref "docs/components/alerts" >}}" class="block p-6 mb-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:hover:bg-gray-700 hover:bg-gray-100 dark:border-gray-700 lg:mb-0">
...
Learn how to <a href="{{< ref "docs/getting-started/react" >}}">install Tailwind CSS and Flowbite with React</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/next-js" >}}">install Tailwind CSS and Flowbite with Next.js and React</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/vue" >}}">install Tailwind CSS and Flowbite with Vue.js</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/nuxt-js" >}}">install Tailwind CSS and Flowbite with Nuxt and Vue 3</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/laravel" >}}">install Tailwind CSS and Flowbite with Laravel</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/svelte" >}}">install Tailwind CSS and Flowbite with Svelte</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/angular" >}}">install Tailwind CSS and Flowbite with Angular</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/rails" >}}">install Tailwind CSS and Flowbite with Ruby on Rails</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/django" >}}">install Tailwind CSS and Flowbite with Django</a>.
...
Learn how to <a href="{{< ref "docs/getting-started/flask" >}}">install Tailwind CSS and Flowbite with Flask</a>.

## Licensing

The library of components from Flowbite is open source under the [MIT License]({{< ref "docs/getting-started/license" >}}).
