...
Let's start by adding a <a href="{{< ref "docs/components/navbar" >}}">Navbar component</a> inside the `_base.html` file:
...
Check out one of the <a href="{{< ref "docs/components/card" >}}">card components</a> from Flowbite and add it to the `index.html` file:
