...
Let's use the <a href="{{< ref "docs/components/modal" >}}#javascript-behaviour">Modal component</a> as an example and copy-paste the markup from the documentation inside your `app.vue` page:
...
Learn more about using <a href="{{< ref "docs/getting-started/typescript" >}}#javascript-behaviour">Flowbite with TypeScript</a> on the official docs page.
